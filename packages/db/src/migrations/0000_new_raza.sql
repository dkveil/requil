...
CREATE TYPE "public"."builder_advanced_element" AS ENUM('social-links', 'unsubscribe', 'custom');--> statement-breakpoint
CREATE TYPE "public"."builder_content_element" AS ENUM('heading', 'paragraph', 'text', 'button', 'divider', 'spacer');--> statement-breakpoint
CREATE TYPE "public"."builder_element_type" AS ENUM('layout', 'content', 'media', 'advanced');--> statement-breakpoint
CREATE TYPE "public"."builder_layout_element" AS ENUM('container', 'section', 'column', 'columns-2', 'columns-3', 'row');--> statement-breakpoint
CREATE TYPE "public"."builder_media_element" AS ENUM('image', 'video');--> statement-breakpoint
...
ALTER TABLE "events" ADD CONSTRAINT "events_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "events" ADD CONSTRAINT "events_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "public"."send_jobs"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "events" ADD CONSTRAINT "events_template_snapshot_id_fkey" FOREIGN KEY ("template_snapshot_id") REFERENCES "public"."template_snapshots"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "events_workspace_occurred_idx" ON "events" USING btree ("workspace_id" uuid_ops,"occurred_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "events_job_id_idx" ON "events" USING btree ("job_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "events_recipient_email_idx" ON "events" USING btree ("recipient_email" citext_ops);--> statement-breakpoint
...
CREATE INDEX "send_recipients_workspace_email_idx" ON "send_recipients" USING btree ("workspace_id" uuid_ops,"email" citext_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "workspace_invitations_open_unique" ON "workspace_invitations" USING btree ("workspace_id" uuid_ops,"invitee_email" citext_ops) WHERE ((accepted_at IS NULL) AND (canceled_at IS NULL));--> statement-breakpoint
CREATE INDEX "workspace_transports_workspace_state_idx" ON "workspace_transports" USING btree ("workspace_id" uuid_ops,"state" enum_ops);--> statement-breakpoint
...
CREATE POLICY "events_select_anon_deny" ON "events" AS PERMISSIVE FOR SELECT TO "anon" USING (false);--> statement-breakpoint
CREATE POLICY "events_insert_anon_deny" ON "events" AS PERMISSIVE FOR INSERT TO "anon";--> statement-breakpoint
CREATE POLICY "events_update_anon_deny" ON "events" AS PERMISSIVE FOR UPDATE TO "anon";--> statement-breakpoint
CREATE POLICY "events_delete_anon_deny" ON "events" AS PERMISSIVE FOR DELETE TO "anon";--> statement-breakpoint
CREATE POLICY "events_select_auth_member" ON "events" AS PERMISSIVE FOR SELECT TO "authenticated";--> statement-breakpoint
CREATE POLICY "events_insert_auth_deny" ON "events" AS PERMISSIVE FOR INSERT TO "authenticated";--> statement-breakpoint
CREATE POLICY "events_update_auth_deny" ON "events" AS PERMISSIVE FOR UPDATE TO "authenticated";--> statement-breakpoint
CREATE POLICY "events_delete_auth_deny" ON "events" AS PERMISSIVE FOR DELETE TO "authenticated";--> statement-breakpoint
...
CREATE POLICY "subscriber_tags_select_anon_deny" ON "subscriber_tags" AS PERMISSIVE FOR SELECT TO "anon" USING (false);--> statement-breakpoint
...
CREATE POLICY "subscriber_tags_update_auth_member" ON "subscriber_tags" AS PERMISSIVE FOR UPDATE TO "authenticated";--> statement-breakpoint
...
CREATE POLICY "usage_counters_daily_delete_auth_deny" ON "usage_counters_daily" AS PERMISSIVE FOR DELETE TO "authenticated";--> statement-breakpoint
...
CREATE POLICY "workspaces_delete_auth_deny" ON "workspaces" AS PERMISSIVE FOR DELETE TO "authenticated";